  ...
  return (
    ...
    <div class="flex-none">
        ...
        <div tabindex="0" class="mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow">
            <div class="card-body">
            <span class="font-bold text-lg">{productsInCart.length} Items</span>
            <span class="text-info">Subtotal: ${productsInCart.reduce((acc, product) => (acc + (product.price * product.amountInCart)), 0)}</span>
